 ...
 */
export function isBuildOutputContent(content: string): boolean {
  ...
  // 3. Source Map Footer (Check last 500 chars)
  const tail = content.slice(-500);
  if (tail.includes("sourceMappingURL=")) {
    return true;
  }

  // 4. Line Length Heuristic (The "Golden Rule")
  ...
  // 5. Line Count Limit (The "Monaco" Guardrail)
